...
class Node(object):
    ...
    def __init__(self, data=None, left=None, right=None, aux = None):
        self.data = data
        self.left = left
        self.right = right
        self.aux = aux
...
class KDNode(Node):
    ...
    def __init__(self, data=None, aux=None, left=None, right=None, axis=None,
        ...
        super(KDNode, self).__init__(data, left, right, aux)
        self.axis = axis
        ...
        while True:
            ...
            if point[current.axis] < current.data[current.axis]:
                if current.left is None:
                    current.left = current.create_subnode(point, aux)
                    break
                else:
                ...
                if current.right is None:
                    current.right = current.create_subnode(point, aux)
                    break
                else:
    ...
    @require_axis
    def create_subnode(self, data, a = None):
        """ Creates a subnode for the current node """

        return self.__class__(data, aux=a,
